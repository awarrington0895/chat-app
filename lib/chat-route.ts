...
export class ChatRoute extends Construct {
    ...
    constructor(scope: Construct, id: string, props: ChatRouteProps) {
        ...
        const integration = new WebSocketLambdaIntegration(`${props.functionName}Integration`, fn)
        ...
        if (props.routeName === '$connect') {
            ...
            const authorizer = new WebSocketLambdaAuthorizer('Authorizer', authorizeHandler, {
